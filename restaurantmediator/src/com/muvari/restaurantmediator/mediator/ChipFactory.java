...
public class ChipFactory {
	...
	public static Integer[][] PRIORITY_CATS = { 
			...
			{ R.drawable.chinese, R.color.light_red, R.string.chinese, R.string.q_chinese },
			{ R.drawable.fast_food, R.color.light_red, R.string.fast_food, R.string.q_fast_food },
			{ R.drawable.greek, R.color.light_red, R.string.greek, R.string.q_greek },
			{ R.drawable.indian, R.color.light_red, R.string.indian, R.string.q_indian },
			{ R.drawable.tomato1, R.color.light_red, R.string.italian, R.string.q_italian },
			{ R.drawable.jap, R.color.light_red, R.string.japanese, R.string.q_japanese },
			{ R.drawable.korean, R.color.light_red, R.string.korean, R.string.q_korean },
			{ R.drawable.greek, R.color.light_red, R.string.mediterranean, R.string.q_mediterranean },
			{ R.drawable.mexi, R.color.light_purple, R.string.mexican, R.string.q_mexican },
			{ R.drawable.new_am, R.color.light_red, R.string.american_new, R.string.q_american_new },
			...
			{ R.drawable.thai, R.color.light_red, R.string.thai, R.string.q_thai },
			{ R.drawable.trad, R.color.light_green, R.string.american_trad, R.string.q_american_trad },
	...
	public static Integer[][] OTHER_CATS = { 
		{ R.drawable.street2, R.color.light_red, R.string.afghan, R.string.q_afghan },
		...
		{ R.drawable.sausage2, R.color.light_red, R.string.german, R.string.q_german },
